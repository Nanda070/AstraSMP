...
public final class ItemAbilityListener implements Listener {
    ...
    public void onHit(EntityDamageByEntityEvent event) {
        ...
        switch (id) {
            case "thunder_hammer" -> target.getWorld().strikeLightning(target.getLocation());
            case "vampire_dagger" -> {
            ...
            case "frost_axe" -> target.addPotionEffect(new PotionEffect(PotionEffectType.SLOWNESS, 100, 2));
        }
    }
